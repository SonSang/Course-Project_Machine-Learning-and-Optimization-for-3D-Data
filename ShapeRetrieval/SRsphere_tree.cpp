...
namespace AF {
	...
	double SRsphere_tree::computeEMD(const SRsphere_tree &a, const SRsphere_tree &b, int level) {
		int begin, end;
		a.get_level_set(level, begin, end);
